...
fn handle_syscall(tf: &TrapFrame, syscall_num: usize) -> isize {
    match Sysno::from(syscall_num as u32) {
        ...
        Sysno::dup3 => sys_dup2(tf.arg0() as _, tf.arg1() as _) as _,
        Sysno::mkdirat => sys_mkdirat(tf.arg0() as _, tf.arg1() as _, tf.arg2() as _) as _,
        Sysno::gettimeofday => sys_gettimeofday(tf.arg0() as _) as _,
        Sysno::uname => sys_uname(tf.arg0() as _) as _,
        Sysno::times => sys_time(tf.arg0() as _) as _,
        ...
        Sysno::clone => sys_clone(tf.arg0() as _, tf.arg1() as _, tf.arg2() as _, tf.arg3() as _, tf.arg4() as _) as _,
